...
<template>
  <div class="category-voting-actions">
    <div v-if="isActive && address" class="category-voting-actions__vote">
      <Button
        @click="handleVote(true)"
        variant="primary"
        :disabled="isCastPending || isConfirmingCast"
        class="category-voting-actions__button category-voting-actions__button--for"
      >
      ...
      <Button
        ...
        variant="secondary"
        :disabled="isCastPending || isConfirmingCast"
        class="category-voting-actions__button category-voting-actions__button--against"
      >
        {{ isCastPending || isConfirmingCast ? t('voting.buttons.voting') : t('voting.buttons.voteAgainst') }}
      </Button>
    </div>

    <div v-if="canExecute" class="category-voting-actions__execute">
      <Button
        @click="handleExecute"
        variant="primary"
        :disabled="isExecutePending || isConfirmingExecute"
        class="category-voting-actions__button category-voting-actions__button--execute"
      >
...
<style lang="scss">
@use "../../assets/scss/categoryVoting/actions.scss";
</style>
