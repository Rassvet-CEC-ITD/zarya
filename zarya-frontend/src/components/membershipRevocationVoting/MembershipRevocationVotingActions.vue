...
<template>
  <div class="membership-revocation-voting-actions">
    <div v-if="isActive && address" class="membership-revocation-voting-actions__vote">
      <Button
        @click="handleVote(true)"
        variant="primary"
        :disabled="isCastPending || isConfirmingCast"
        class="membership-revocation-voting-actions__button membership-revocation-voting-actions__button--for"
      >
      ...
      <Button
        ...
        variant="secondary"
        :disabled="isCastPending || isConfirmingCast"
        class="membership-revocation-voting-actions__button membership-revocation-voting-actions__button--against"
      >
        {{ isCastPending || isConfirmingCast ? t('voting.buttons.voting') : t('voting.buttons.voteAgainst') }}
      </Button>
    </div>

    <div v-if="canExecute" class="membership-revocation-voting-actions__execute">
      <Button
        @click="handleExecute"
        variant="primary"
        :disabled="isExecutePending || isConfirmingExecute"
        class="membership-revocation-voting-actions__button membership-revocation-voting-actions__button--execute"
      >
...
<style lang="scss">
@use "../../assets/scss/membershipRevocationVoting/actions.scss";
</style>
